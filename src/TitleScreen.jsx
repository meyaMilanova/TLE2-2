...
const TitleScreen = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-green-900 relative">
            ...
            <img src={background} alt='background' className='w-full h-full absolute top-0 left-0'  style={{imageRendering: "pixelated"}}/>
            ...
            <div className="absolute top-0 left-0 right-0 bottom-0 w-full flex flex-col items-center justify-between my-[1.8vw] z-10">
                <div className='flex w-[60vw] ml-[20vw] mr-[10vw] justify-between'>
                    <img className='w-[5vw] h-auto' src={batcat}  style={{imageRendering: "pixelated"}} alt="Batcat Background Decoration"/>
                    <img className='w-[3.5vw] pt-[2.5vw] h-auto rotate-[25deg]'  style={{imageRendering: "pixelated"}} src={trash1} alt="Trash Background Decoration"/>
                </div>

                <div className='flex ml-[5vw] gap-[40vw] pr-[40vw] justify-between w-auto pt-[1.2vw]'>
                    <img className='w-[3.5vw] h-auto pb-[4vw] rotate-[-35deg]'  style={{imageRendering: "pixelated"}} src={trash2} alt="Trash Background Decoration"/>
                    <img className='w-[4vw] h-auto pt-[4vw]' src={avatar1}  style={{imageRendering: "pixelated"}} alt="Avatar Background Decoration"/>
                </div>
                <div className='flex mx-[5vw] justify-between w-full'>
                    <img className='w-[5.5vw] h-auto' src={avatar2}  style={{imageRendering: "pixelated"}} alt="Avatar Background Decoration"/>
                    <img className='w-[4vw] h-auto' src={applepet}  style={{imageRendering: "pixelated"}} alt="Avatar's Pet Background Decoration"/>
                    <img className='w-[5.5vw] h-auto' src={avatar3}  style={{imageRendering: "pixelated"}} alt="Avatar Background Decoration"/>
                </div>
            ...
            <img className='w-[20vw] h-auto' src={grass}/>
                <img className='w-[20vw] h-auto' src={grass}  style={{imageRendering: "pixelated"}}/>
                <img className='w-[20vw] h-auto' src={grass}  style={{imageRendering: "pixelated"}}/>
                <img className='w-[20vw] h-auto' src={grass}  style={{imageRendering: "pixelated"}}/>
                <img className='w-[20vw] h-auto' src={grass}  style={{imageRendering: "pixelated"}}/>
            </div>
